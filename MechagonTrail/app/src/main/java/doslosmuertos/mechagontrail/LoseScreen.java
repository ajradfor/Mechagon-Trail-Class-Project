...
public class LoseScreen extends Activity {
    ...
    private MechagonTrailApplication app;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        message = (TextView)findViewById(R.id.loserMessage);

        if (gs.getMech().getFuel() == 0) {
            message.setText("You ran out of fuel!");
        }
        if (gs.getMech().getHealth() == 0) {
            message.setText("The mech was too damaged to be repaired. You all died!");
        }
